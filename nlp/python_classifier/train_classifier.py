...
# Contains code copied from hugginface/pytorch-transformers/examples/run_glue.py
...
""" Finetuning the BERT model for sequence classification."""
...
from data import convert_examples_to_features, DataProcessor
