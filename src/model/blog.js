...
export async function getAllPublished(dbClient, start, end) {
...
export async function getHomePage(dbClient) {
    return db.selectAll(dbClient,
...
export async function getForView(dbClient, id) {
...
export async function getForEdit(dbClient, id) {
