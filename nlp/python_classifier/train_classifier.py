...
def create_training_data():
    ...
    otherDataLength = 5000

    train_data = unparsed_data("train/questions1.json", questionDataLength, 20)
    ...
    train_data = unparsed_data("train/questions2.json", questionDataLength, 20)
    ...
    train_data = unparsed_data("train/commands.json", commandDataLength, 20)
    ...
    '''
    train_data = parsed_data("train/chatty1.json", chattyDataLength, 20)
...
'''
Training the model with individual words instead of sentences as a whole worked a lot better.
'''
